...
public class EditPhong extends javax.swing.JPanel {
    ...
    public ModelHoGiaDinh getData() {
        ...
        try {
            ...
            // Tiếp tục xử lý với các giá trị hợp lệ
            // Ví dụ: tạo đối tượng mới hoặc lưu vào cơ sở dữ liệu
            // ModelHoGiaDinh model = new ModelHoGiaDinh(...);
            return new ModelHoGiaDinh(soPhong, dienTich, soNguoi, soXeMay, soOto);
