...
public class ModelTaiKhoan extends Model {
    ...
    private boolean gioiTinh = true, admin = false;

    // Constructor
    public ModelTaiKhoan(String hoTen, Date ngaySinh, String sdt, String CCCD, String soPhong, String tenDangNhap, String ghiChu, boolean gioiTinh, String ID, boolean admin) {
        this.hoTen = hoTen;
