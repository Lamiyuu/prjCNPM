...
import HomeFramePackage.HomeCardPackage.CardModel;
import java.net.URL;
...
public class KhieuNaiCard extends javax.swing.JPanel {
    ...
    public KhieuNaiCard() {
        ...
        try (Connection conn = Database.DatabaseConnection.getConnection();
           ...
           // Truy vấn dữ liệu
           String daDuyet = "SELECT SUM(ID) AS approve FROM khieu_nai WHERE xetDuyet = 'Đã duyệt'";
           String tuChoi = "SELECT SUM(ID) AS dismiss FROM khieu_nai WHERE xetDuyet = 'Từ chối'";
           String dangCho = "SELECT SUM(ID) AS pending FROM khieu_nai WHERE xetDuyet = 'Đang chờ'";
